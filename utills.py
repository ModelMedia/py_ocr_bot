...
def settings_msg(data_set=None, default=True, lang=False, limits=False):
    ...
    logger.info('settings_msg arg: default={}, lang={}, limits={} update_flag={}'.format(default, lang, limits, update_flag))
    ...
    settings_str = 'settings: language - {}, content format - {} text, processing result - as {}.'.format(data_set['lang']['desc'], data_set['isTable']['desc'], data_set['result']['desc'])
...
def language_buttons_inline():
    ...
    col_btn = 4
    rows_buttons = [list_buttons_inline[i:i + col_btn] for i in range(0, len(list_buttons_inline), col_btn)]
